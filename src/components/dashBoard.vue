<template>
  <a-layout id="components-layout-demo-fixed">
    <a-layout-header :style="{ position: 'fixed', zIndex: 1, width: '100%' }">
      <div class="logo" />
      <a-menu theme="dark" mode="horizontal":default-selected-keys="['1']":style="{ lineHeight: '64px', float: 'left' }">
    ...
    <a-layout-content :style="{padding: '0px 50px',marginTop: '64px' }">
      <div :style="{ background: '#fff', padding: '24px', height: '1800px' }">
        ...
        <div :style="{margin: '50px 0px'}">
          <a-input-search placeholder="输入：https://aisainfo-sec.com,为您的做最全面的体检" enter-button="体检" size="large" @search="onSearch"/>
        </div>
